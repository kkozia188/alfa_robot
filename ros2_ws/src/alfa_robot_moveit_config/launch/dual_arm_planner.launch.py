...
def generate_launch_description():
    ...
    declared_arguments = [
        ...
        DeclareLaunchArgument("container_width", default_value="2.4"),
    ...
    dual_arm_planner = Node(
        ...
        parameters=[
            ...
            moveit_config.joint_limits,
            {
                ...
                "extract_loaded_preserve_lower_updown": ParameterValue(LaunchConfiguration("extract_loaded_preserve_lower_updown"), value_type=bool),
