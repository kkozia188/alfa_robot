...
**姿态合同：**`updown=-0.3m`，左臂 `J1～J7=[155,-105,20,90,-90,-40,0]°`，右臂为 `[25,-105,-20,90,-90,40,0]°`，头部关节为0。直接读取 SRDF `whole_body/home`，不复制一套角度到规划器。卸货姿态另以 `unloading` 命名；默认远端流程后置释放，显式 `loaded_home` 才携箱回 Home。
