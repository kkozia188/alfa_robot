...
- 导入提交：`f2454a679c23b84a774cc8a43c5b294cbbd340a3`
- 导入日期：2026-09-19
...
- V3.1.1 机械原始零位已关于车体中轴面镜像，不对右 J1/J5 叠加逻辑偏移；
  四套镜像姿态均满足 `right_jointN=-left_jointN`。
- 默认初始（`home`）：`updown=-0.3m`，左臂
  `[155, -105, 20, 90, -90, -40, 0] deg`，右臂
  `[-155, 105, -20, -90, 90, 40, 0] deg`
- 第二初始（`second_home`）：`updown=-0.6m`，左臂
  `[30, 80, 20, 90, 90, 60, 0] deg`，右臂
  `[-30, -80, -20, -90, -90, -60, 0] deg`
- 卸货（`unloading`）：`updown=-0.3m`，左臂
  `[130, -105, -180, 20, -90, -30, 0] deg`，右臂
  `[-130, 105, 180, -20, 90, 30, 0] deg`
- 第二卸货（`second_unloading`）：`updown=-0.6m`，左臂
  `[0, 100, 0, -45, 100, 45, 0] deg`，右臂
  `[0, -100, 0, 45, -100, -45, 0] deg`
