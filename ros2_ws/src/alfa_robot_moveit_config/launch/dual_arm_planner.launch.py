...
def generate_launch_description():
    ...
    declared_arguments = [
        ...
        DeclareLaunchArgument("front_z_reach_lower", default_value="0.9"),
        DeclareLaunchArgument("front_z_reach_upper", default_value="1.3"),
        ...
        DeclareLaunchArgument("extract_loaded_planning_attempts", default_value="4"),
