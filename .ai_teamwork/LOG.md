...
## 2026-09-21 运控算法 / Codex / V3前11轮侧吸Action与仿真Preview 0.2.0
- 做了什么：将90cm箱墙前11轮侧吸任务串成 `PREGRASP→APPROACH→PLACE→HOME`，加入解析IK候选回退、35cm抽离、携箱回初始、两套放置、释放删箱、空载回初始及第一/第二初始姿态切换；缓存支持3轮单臂 `NO_MOVE`。
